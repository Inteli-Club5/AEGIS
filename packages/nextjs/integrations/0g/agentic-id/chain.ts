...
export const ZERO_G_GALILEO_CHAIN_ID = parseChainId(getEnvValue(["ZERO_G_GALILEO_CHAIN_ID", "CHAIN_ID"]));

export const getServerZeroGGalileoRpcUrl = () =>
  getEnvValue(["ZERO_G_GALILEO_RPC_URL", "RPC_URL"]) || DEFAULT_0G_GALILEO_RPC_URL;

export const getZeroGExplorerBaseUrl = () =>
  (getEnvValue(["ZERO_G_EXPLORER_BASE_URL", "EXPLORER_BASE_URL"]) || DEFAULT_0G_EXPLORER_BASE_URL).replace(/\/$/, "");

export const getZeroGStorageIndexerUrl = () =>
  getEnvValue(["ZERO_G_STORAGE_INDEXER_URL", "STORAGE_INDEXER"]) || DEFAULT_0G_STORAGE_INDEXER_URL;

export const getZeroGStorageUriPrefix = () =>
  getEnvValue(["ZERO_G_STORAGE_URI_PREFIX", "STORAGE_URI_PREFIX"]) || DEFAULT_0G_STORAGE_URI_PREFIX;

export const getZeroGAgenticIdContractAddress = () =>
  getEnvValue(["ZERO_G_AGENTIC_ID_CONTRACT_ADDRESS", "AGENTIC_ID_CONTRACT"]) || DEFAULT_0G_AGENTIC_ID_CONTRACT_ADDRESS;
